...
public class OrderDAOImpl implements OrderDAO {
    ...
    public String generateNewID() throws SQLException, ClassNotFoundException {
       /* Connection connection = DBConnection.getDbConnection().getConnection();
        ...
        ResultSet resultSet = SQLUtill.execute("SELECT oid FROM Orders ORDER BY oid DESC LIMIT 1;");
    ...
    public boolean add(OrderDTO dto) throws SQLException, ClassNotFoundException {
       /* Connection connection = DBConnection.getDbConnection().getConnection();
        ...
        return SQLUtill.execute("INSERT INTO Orders (oid, date, customerID) VALUES (?,?,?)",dto.getOrderId(),dto.getOrderDate(),dto.getCustomerId());
